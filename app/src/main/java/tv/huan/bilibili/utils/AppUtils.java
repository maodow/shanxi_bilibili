...
public final class AppUtils {
    ...
    /**
     * Register the statpus of application changed listener.
     *
    ...
    public static boolean installAppSilent(final File file,
        ...
        if (commandResult.successMsg != null
            ...
            LogUtil.log("AppUtil => installAppSilent successMsg: " + commandResult.successMsg +
    ...
    public static boolean isAppRoot() {
        ...
        if (result.errorMsg != null) {
            LogUtil.log("AppUtils", "isAppRoot() called" + result.errorMsg);
        }
        return false;
    }
...
//            LogUtils.e("ProcessUtils", list.toString());
//            if (list.size() <= 0) {
//                LogUtils.e("ProcessUtils",
...
//    }
    ...
    public static String getMacAddress(Context context) {
        String mac = getEthMacAddress("eth");
    ...
    public static String getWifiMacAddress(Context context) {
        try {
            ...
            return info.getMacAddress().toLowerCase(Locale.getDefault());
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "";
