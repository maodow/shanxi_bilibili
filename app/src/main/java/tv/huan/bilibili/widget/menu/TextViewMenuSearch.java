...
public class TextViewMenuSearch extends TextViewPlus {
    public TextViewMenuSearch(@NonNull Context context) {
        super(context);
    }

    public TextViewMenuSearch(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public TextViewMenuSearch(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
