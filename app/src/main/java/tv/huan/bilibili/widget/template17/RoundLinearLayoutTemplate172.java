...
public class RoundLinearLayoutTemplate172 extends RoundRelativeLayout {
    public RoundLinearLayoutTemplate172(Context context) {
        super(context);
    }

    public RoundLinearLayoutTemplate172(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RoundLinearLayoutTemplate172(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public RoundLinearLayoutTemplate172(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
