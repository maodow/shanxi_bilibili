...
public class Special6Presenter extends BasePresenterImpl<Special6View> {

    private final List<SpecialBean.ItemBean> mData = new ArrayList<>();

    public Special6Presenter(@NonNull Special6View specialView) {
        super(specialView);
    }

    protected void setAdapter() {
        Context context = getView().getContext();
        RecyclerView recyclerView = getView().findViewById(R.id.special6_list);
        ...
        recyclerView.addItemDecoration(new RecyclerView.ItemDecoration() {
            ...
            public void getItemOffsets(@NonNull Rect outRect, @NonNull View view, @NonNull RecyclerView parent, @NonNull RecyclerView.State state) {
                ...
                int offset = view.getResources().getDimensionPixelOffset(R.dimen.dp_30);
                if (position % 2 == 0) {
        ...
        recyclerView.setAdapter(new RecyclerView.Adapter() {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                View inflate = LayoutInflater.from(context).inflate(R.layout.activity_special6_item, parent, false);
        ...
        addDisposable(Observable.create(new ObservableOnSubscribe<Boolean>() {
                ...
                .flatMap(new Function<Boolean, Observable<BaseResponsedBean<SpecialBean>>>() {
                    ...
                    public Observable<BaseResponsedBean<SpecialBean>> apply(Boolean aBoolean) {
                        int specialId = getView().getIntExtra(Special6Activity.INTENT_SPECIALID, 0);
