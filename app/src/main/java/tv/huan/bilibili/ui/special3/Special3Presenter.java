...
public class Special3Presenter extends BasePresenterImpl<Special3View> {

    private final List<SpecialBean.ItemBean> mData = new ArrayList<>();

    public Special3Presenter(@NonNull Special3View specialView) {
        super(specialView);
    }

    protected void setAdapter() {
        Context context = getView().getContext();
        RecyclerView recyclerView = getView().findViewById(R.id.special3_list);
        ...
        recyclerView.setAdapter(new RecyclerView.Adapter() {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                View inflate = LayoutInflater.from(context).inflate(R.layout.activity_special3_item, parent, false);
            ...
            public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
                try {
                    SpecialBean.ItemBean itemBean = mData.get(position);
                    TextView textView = holder.itemView.findViewById(R.id.special3_item_name);
                    textView.setText(itemBean.getName());
                    ImageView imageView = holder.itemView.findViewById(R.id.special3_item_img);
        ...
        addDisposable(Observable.create(new ObservableOnSubscribe<Boolean>() {
                ...
                .flatMap(new Function<Boolean, Observable<ResponsedBean<SpecialBean>>>() {
                    ...
                    public Observable<ResponsedBean<SpecialBean>> apply(Boolean aBoolean) {
                        int specialId = getView().getIntExtra(Special3Activity.INTENT_SPECIALID, 0);
