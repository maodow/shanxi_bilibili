...
public class Special4Presenter extends BasePresenter<Special4View> {
    ...
    public Special4Presenter(@NonNull Special4View specialView) {
        super(specialView);
    }
    ...
    protected void setAdapter() {
        ...
        RecyclerView recyclerView = getView().findViewById(R.id.special4_list);
        ...
        recyclerView.setAdapter(new RecyclerView.Adapter() {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                View inflate = LayoutInflater.from(context).inflate(R.layout.activity_special4_item, parent, false);
            ...
            public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
                try {
                    SpecialBean.ItemBean itemBean = mData.get(position);
                    TextView textView = holder.itemView.findViewById(R.id.special4_item_name);
                    textView.setText(itemBean.getName());
                    ImageView imageView = holder.itemView.findViewById(R.id.special4_item_img);
